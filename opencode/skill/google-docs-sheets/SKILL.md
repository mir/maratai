...
```bash
# Export to stdout
uv run --directory ${PLUGIN_ROOT}/skills/google-docs-sheets scripts/docs.py export <DOC_ID_OR_URL> --stdout

# Export to files (default ./exports when --stdout is not set)
uv run --directory ${PLUGIN_ROOT}/skills/google-docs-sheets scripts/docs.py export <DOC_ID_OR_URL>

# Write to a specific directory
uv run --directory ${PLUGIN_ROOT}/skills/google-docs-sheets scripts/docs.py export <DOC_ID_OR_URL> --output-dir ./exports

# Write and print
uv run --directory ${PLUGIN_ROOT}/skills/google-docs-sheets scripts/docs.py export <DOC_ID_OR_URL> --output-dir ./exports --stdout
```
...
uv run --directory ${PLUGIN_ROOT}/skills/google-docs-sheets scripts/sheets.py export <SHEET_ID_OR_URL> --stdout

# Export all tabs to files (default ./exports when --stdout is not set)
uv run --directory ${PLUGIN_ROOT}/skills/google-docs-sheets scripts/sheets.py export <SHEET_ID_OR_URL>

# Export specific tabs
uv run --directory ${PLUGIN_ROOT}/skills/google-docs-sheets scripts/sheets.py export <SHEET_ID_OR_URL> --tab "Summary" --tab "Data"

# Header control
uv run --directory ${PLUGIN_ROOT}/skills/google-docs-sheets scripts/sheets.py export <SHEET_ID_OR_URL> --header-row 2
uv run --directory ${PLUGIN_ROOT}/skills/google-docs-sheets scripts/sheets.py export <SHEET_ID_OR_URL> --no-header
```
